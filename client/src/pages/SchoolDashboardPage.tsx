...
export default function SchoolDashboardPage() {
  ...
  return <StudioPageFrame title="สำนักเรียน" eyebrow="ดูภาพรวมการเติบโตของผู้เรียน">
    {!user && <div className="auth-banner"><GraduationCap size={20} /><div><strong>แดชบอร์ดตัวอย่างสำหรับผู้ดูแลสำนักเรียน</strong><span>เข้าสู่ระบบเพื่อดูข้อมูลจริงของสำนักเรียนและรายงานรายบุคคล</span></div><button onClick={() => startLogin()}>เข้าสู่ระบบ</button></div>}
